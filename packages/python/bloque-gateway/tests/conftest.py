"""Shared fixtures for bloque-gateway tests."""

import pytest
from bloque_gateway.circuit_breaker import CircuitBreaker, CircuitBreakerSettings
from bloque_gateway.proxy import ProxyHandler, ProxyRoute, ProxySettings
from bloque_gateway.rate_limiter import InMemoryBackend, RateLimiterSettings
