...
from bloque_notifications.models.settings import TemplateSettings
    ...
    def _init_jinja2(self) -> None:
        ...
        try:
            ...
            logger.info(
                ...
                "Install with: uv add bloque-notifications[templates]"
            )
            self._jinja_available = False
        ...
        *,
        ...
        Args:
            ...
            tenant_id: Optional tenant prefix. If None and tenant_aware,
                resolves from bloque_multitenant context.
        """
