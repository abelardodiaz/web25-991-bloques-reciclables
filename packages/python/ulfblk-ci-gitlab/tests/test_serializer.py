...
from ulfblk_ci_gitlab.serializer import pipeline_to_yaml, write_pipeline
...
def test_preserves_var_references():
    ...
    from ulfblk_ci_gitlab.generators import generate_release_pipeline
    from ulfblk_ci_gitlab.models import PublishConfig
