...
from bloque_testing.db import create_tables, create_test_engine, create_test_session_factory
...
class _TestModel(_TestBase):
    __tablename__ = "_bloque_testing_test"
...
class TestCreateTables:
    async def test_creates_model_tables(self):
        ...
        assert "_bloque_testing_test" in table_names
