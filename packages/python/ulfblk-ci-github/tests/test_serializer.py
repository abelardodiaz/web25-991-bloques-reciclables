...
from ulfblk_ci_github.serializer import workflow_to_yaml, write_workflow
...
def test_preserves_secrets_expression():
    ...
    from ulfblk_ci_github.generators import generate_release_workflow
    from ulfblk_ci_github.models import PublishConfig
