...
> Ultima actualizacion: 2026-03-20 (Fase 4: bloque-ci-gitlab)
...
| `bloque-ci-gitlab` | GitLab CI pipeline generator: CI + release/publish para Python y TypeScript | `uv add bloque-ci-gitlab` | MVP |
